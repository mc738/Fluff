...
type ParsableInput =
        ...
        member pi.GetChar(i) = match pi.IsInBounds(i) with true -> Some pi.Input.[i] | false -> None 
        ...
        member pi.Is2Chars(c1, c2) =
            ...
            match pi.CheckChar(c1, pi.Position), pi.CheckChar(c2, pi.Position + 1), (c1 = c2 && pi.CheckChar(c1, pi.Position + 3)) with
        ...
        member pi.NextNonNested() =
            ...
            member pi.CurrentChar = match pi.InBounds() with true -> pi.Input.[pi.Position] | false -> '\u0000'